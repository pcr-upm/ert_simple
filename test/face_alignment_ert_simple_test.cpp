/** ****************************************************************************
 *  @file    face_alignment_ert_simple_test.cpp
  ...
  )
{
  ...
  boost::shared_ptr<upm::FaceAlignment> fa(new upm::FaceAlignmentEnsemble("data/"));
...
//  viewer->init(0, 0, "face_alignment_ert_simple_test");
//  showResults(viewer, ticks, 0, frame, composite, faces, ann);

  UPM_PRINT("End of face_alignment_ert_simple_test");
  return EXIT_SUCCESS;
};
